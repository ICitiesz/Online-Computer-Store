<?php
    ...
    User\User::updateProfile(User\UserSession::getSessionUserID());

    /* Buttons links to other page. */
    Utils\Utils::redirectPage("post", "container-billing-info-btn", "/OPCS/en/account/billing-information");
...
<head>
    ...
    <script src="/OPCS/resources/js/user/user-profile.js"></script>
    <script src="/OPCS/resources/js/user/user-general.js"></script>
...
<!-- Nav bar -->
<div class="navbar position-sticky navbar-expand-md bg-dark navbar-dark" style="z-index: 1;">
...
<!-- Main body container -->
<div class="container-fluid main-body-container gradient-dark-2 px-0">
        ...
        <div class="row mx-5 panel-container"> <!-- Height = 900px -->
            ...
            <div class="col-lg-3 button-container">
                ...
                <div class="d-grid px-4 py-5 gap-3">
                    <form class="d-grid py-5 gap-3" action="" method="post">
                        <button class="btn p-3 button-border selected-btn gradient-btn rounded-3" name="container-profile-btn">
                            Profile
                        </button>
                        ...
                        <button class="btn p-3 button-border gradient-btn rounded-3" name="container-billing-info-btn">
                            Billing Information
                        </button>
            ...
            <div class="col-lg-9 px-5">
                ...
                <div class="container rounded-3 my-2 px-5 position-relative inner-content-frame lighter-dark"> <!-- Height = 650px -->
                    <div class="row pt-3">
                        <h3 class="text-center pb-1">Profile</h3>
                        <hr>
                    </div>

                    <div class="row-cols">
                        <form action="" method="post" class="d-grid gap-5">
                            <div class="container">
                                <label for="profile-username" class="ps-2">Username: </label>
                                <input type="text" class="form-control profile-username-input" id="profile-username" name="profile_username" value="<?php echo $user->getUsername();?>" required>
                            </div>

                            <div class="container">
                                <label for="profile-gender" class="ps-2">Gender: </label>
                                <select class="form-select profile-gender-input" id="profile-gender" name="profile_gender" type="text" required>
                                    ...
                                    <option value="other" <?php if ($user->getGender() === "other") {echo "selected";}?>>Other</option>
                                </select>
                            </div>

                            <div class="container">
                                <label for="profile-phone-number" class="ps-2">Phone Number: </label>
                                <input class="form-control profile-phone-number-input" id="profile-phone-number" type="tel" name="profile_contact" value="<?php echo $user->getContact();?>" required>
                            </div>

                            <div class="container">
                                <label for="profile-email" class="ps-2">Email Address: </label>
                                <input class="form-control profile-email-address-input" id="profile-email" type="email" name="profile_email" value="<?php echo $user->getEmail();?>" required>
                            </div>

                            <button class="btn btn-lg position-absolute profile-save px-4" name="profile-save" type="submit">Save</button>
                        </form>
                    </div>
                </div>
            </div>
