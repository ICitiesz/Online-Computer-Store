...
<head>
    ...
    <link href="/OPCS/resources/css/user/user-account-security.css" rel="stylesheet">
        ...
        <div class="row mx-5 panel-container"> <!-- Height = 900px -->
            ...
            <div class="col-lg-3 button-container">
                ...
                <div class="d-grid px-4 py-5 gap-3">
                    <form class="d-grid py-5 gap-3" action="" method="post">
                        ...
                        <button class="btn p-3 button-border selected-btn gradient-btn rounded-3" name="container-security-btn">
                            Account Security
                        </button>
            ...
            <div class="col-lg-9 px-5">
                ...
                <div class="container rounded-3 my-2 px-5 position-relative inner-content-frame lighter-dark"> <!-- Height = 650px -->
                    <div class="row pt-3">
                        <h3 class="text-center pb-1">Account Security</h3>
                        <hr>
                    </div>
                    ...
                    <div class="row-cols">
                        <form action="" method="post" class="d-grid gap-5">
                            <div class="container">
                                <label for="account-security-new-password" class="ps-2">New Password: </label>
                                <input type="password" class="form-control profile-new-password-input profile-username-input" name="profile_password" id="account-security-new-password" required>
                            </div>

                            <div class="container">
                                <label for="account-security-new-confirm-password" class="ps-2">New Confirm Password: </label>
                                <input class="form-control profile-new-confirm-password-input" id="account-security-new-confirm-password" type="password" name="profile_confirm_password" required>
                            </div>

                            <div class="container pb-0">
                                <p class="mb-0" style="margin-left: 35px"><small>Forgot your password? <a href="">Click here!</a></small></p>
                                <button class="btn btn-lg password-save mt-2 px-4" name="new_password_save" type="submit">Save</button>
                            </div>
                        </form>
                    </div>
