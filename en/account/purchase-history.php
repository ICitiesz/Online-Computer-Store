<?php
    ...
    if (Utils\Utils::isMethodVarSet("post", "productID")) {
        User\UserSession::addSessionVar("productID", $_POST["productID"]);
    }

    User\User::updateProfilePic(User\UserSession::getSessionUserID());
    User\PurchaseHistory::addProductReview(User\UserSession::getSessionUserID());
...
<head>
    ...
    <link href="/OPCS/resources/css/user/user-purchase-history.css" rel="stylesheet">
    ...
    <div class="row mx-5 panel-container"> <!-- Height = 900px -->
        ...
        <div class="col-lg-3 button-container">
            ...
            <div class="d-grid px-4 py-5 gap-3">
                <form class="d-grid py-5 gap-3" action="" method="post">
                    ...
                    <button class="btn p-3 button-border selected-btn gradient-btn rounded-3" name="container-purchase-history-btn">
                        Purchase History
                    </button>
                </form>
            </div>
        ...
        <div class="col-lg-9 px-5">
            ...
            <div class="container rounded-3 my-2 px-5 position-relative inner-content-frame lighter-dark"> <!-- Height = 650px -->
                <div class="row pt-3">
                    <h3 class="text-center pb-1">Purchase History</h3>
                    <hr>
                </div>

                <div class="container overflow-auto" style="max-height: 500px;">
                    <div class="accordion d-grid" id="purchase-history" style="gap: 2px">
                        <?php
                        User\PurchaseHistory::renderPurchaseHistory();
                        ?>
                    </div>

                    <?php User\PurchaseHistory::renderRatingModal(); ?>
                </div>
            </div>
        </div>
    </div>
...
<script src="/OPCS/resources/js/user/user-purchase-history.js"></script>
</html>