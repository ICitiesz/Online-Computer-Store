            ...
            <section id="footer-pages" class="section">
                ...
                <div class="content container">
                    <div class="answer-content">
                        <div class="secondary-title">Collected Information</div>
                        <div class="answer">
                            We only collect the information that needed for the registration process at our website or when fill
                            up the registration form on the site. The information that we gathered are <strong>voluntarily</strong> submitted by
                            customers to us. We only collect customer's personal information during the account registration on our site.
                        </div>
                    </div>
                    <div class="answer-content">
                        <div class="secondary-title">Personal Identification Details</div>
                        <div class="answer">
                            Your personal identification details are used to process your order of the products, customize your profile information,
                            internal usage with legal requirements and also to update your status of online shopping in our site.
                        </div>
                    </div>
                    <div class="answer-content">
                        <div class="secondary-title">Confidentiality</div>
                        <div class="answer">
                            Your personal information such as Billing Address, Contact Number are well kept <strong>secret and confidential</strong> with us.
                            We will never share any of your personal details to any third party. Our sites do apply appropriate security measurement
                            in order to keep all the customers information safe at all time.
                        </div>
                    </div>
                    <div class="answer-content">
                        <div class="secondary-title">Changes to our Privacy Policy</div>
                        <div class="answer">
                            <strong>OP Computer Shop</strong> have the rights to do any changes or updates to the <strong>Privacy Policy</strong> contents without
                            giving any prior notice to the customers. Do keep track on the Privacy Policy page on our website.
                        </div>
                    </div>
                    <div class="answer-content">
                        <div class="secondary-title">Security</div>
                        <div class="answer">
                            Our company website do apply appropriate security measurement in order to prevent the leaking of customer's personal identification
                            details to third parties, illegal disclosure and hackers. However bear in mind that any information
                            transmitted through Internet is <strong>NOT</strong> 100% guaranteed safe and secure.
                        </div>
                    </div>
                </div>
            </section>
